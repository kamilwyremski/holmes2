...
CREATE TABLE IF NOT EXISTS `classified` (
  ...
  `price_negotiate` int(1) NOT NULL DEFAULT '0',
  `price_free` int(1) NOT NULL DEFAULT '0',
  ...
  `state2_id` int(11) NOT NULL DEFAULT '0',
  `type_id` int(11) NOT NULL DEFAULT '0',
  `description` longtext,
  `youtube_url` varchar(128) NOT NULL DEFAULT '',
  `active` int(1) NOT NULL DEFAULT '0',
  `admin_confirmed` int(1) DEFAULT '0',
...
('classified', 'Classified', 'Wiadomość do ogłoszenia {classified_name}', '<p>Witaj!</p>\r\n\r\n<p>Została do Ciebie wysłana wiadomość ze strony <a href=\"{base_url}\">{base_url}</a> dotycząca ogłoszenia&nbsp;<a href=\"{classified_url}\">{classified_url}</a></p>\r\n\r\n<p>Nadawca: {name}</p>\r\n\r\n<p>Adres email: {email}</p>\r\n\r\n<p>Wiadomość: {message}</p>\r\n'),
('classifieds_finish', 'Classifieds - finish displaying', 'Zakończenie wyświetlania ogłoszenia w serwisie {title}', '<p>Witaj!</p>\r\n\r\n<p>Twoje ogłoszenia&nbsp;przestały&nbsp;być aktywne w serwisie &nbsp;<a href=\"{base_url}\">{base_url}</a>&nbsp;w dniu {date}:</p>\r\n\r\n<p><b>{classifieds_list}</b></p>\r\n\r\n<p>Aby je ponownie aktywować zaloguj się na swoje konto:&nbsp;<a href=\"{base_url}/moje_ogloszenia\">{base_url}/moje_ogloszenia</a></p>\r\n\r\n<p>Dziękujemy za zainteresowanie naszym serwisem</p>\r\n\r\n<p><br />\r\nPozdrawiamy<br />\r\n{title}</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>{link_logo}</p>\r\n'),
('classifieds_finish_not_logged', 'Classifieds - finish displaying (not logged)', 'Zakończenie wyświetlania ogłoszenia w serwisie {title}', '<p>Witaj!</p>\r\n\r\n<p>Twoje ogłoszenia&nbsp;przestały&nbsp;być aktywne w serwisie &nbsp;<a href=\"{base_url}\">{base_url}</a>&nbsp;w dniu {date}:</p>\r\n\r\n<p><b>{classifieds_list}</b></p>\r\n\r\n<p>Dziękujemy za zainteresowanie naszym serwisem</p>\r\n\r\n<p><br />\r\nPozdrawiamy<br />\r\n{title}</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>{link_logo}</p>\r\n'),
('classified_start', 'Classified - start displaying', 'Aktywacja ogłoszenia {classified_name}', '<p>Witaj!</p>\r\n\r\n<p>Dodałeś ogłoszenie&nbsp;<a href=\"{classified_url}\">{classified_url}</a>&nbsp;na stronie&nbsp;<a href=\"{base_url}\">{base_url}</a>.</p>\r\n\r\n<p>Dziękujemy za zainteresowanie naszym serwisem</p>\r\n\r\n<p>Pozdrawiamy<br />\r\n{title}<br />\r\n<br />\r\n<a href=\"{base_url}\">{link_logo}</a></p>\r\n'),
('classified_start_not_logged', 'Classified - start displaying (not logged)', 'Aktywacja ogłoszenia {classified_name}', '<p>Witaj!</p>\r\n\r\n<p>Aby aktywować ogłoszenie&nbsp;{classified_name} kliknij w link:&nbsp;<a href=\"{classified_activate_link}\">{classified_activate_link}</a>&nbsp;</p>\r\n\r\n<p>Link do edycji ogłoszenia:&nbsp;<a href=\"{classified_edit_link}\">{classified_edit_link}</a>&nbsp;</p>\r\n\r\n<p>Pozdrawiamy<br />\r\n{title}<br />\r\n<br />\r\n<a href=\"{base_url}\">{link_logo}</a></p>\r\n'),
...
('finish_promote', 'Finish promote', 'Zakończenie promowania ogłoszenia {classified_name}', '<p>Witaj,</p>\r\n\r\n<p>Twoje ogłoszenie&nbsp;<a href=\"{classified_url}\">{classified_url}</a>&nbsp;na stronie&nbsp;<a href=\"{base_url}\">{base_url}</a>&nbsp;przestało&nbsp;być promowane.</p>\r\n\r\n<p>Wyr&oacute;żnij się na tle konkurencji i ponownie wypromuj swoje ogłoszenie!</p>\r\n\r\n<p>Więcej szczeg&oacute;ł&oacute;w na stronie&nbsp;<a href=\"{classified_url}\">{classified_url}</a>&nbsp;w zakładce &quot;Promuj&quot;</p>\r\n\r\n<p>Pozdrawiamy<br />\r\n{title}<br />\r\n<br />\r\n<a href=\"{base_url}\">{link_logo}</a></p>\r\n\r\n<p>&nbsp;</p>\r\n'),
...
('report_abuse', 'Report abuse', 'Zgłoszono nadużycie w ogłoszenie {classified_name}', '<p>Witaj!</p>\r\n\r\n<p>Zostało zgłoszone nadużycie w ogłoszeniu&nbsp;<a href=\"{classified_url}\">{classified_url}</a></p>\r\n\r\n<p>Adres email zgłaszającego: {email}</p>\r\n\r\n<p>Wiadomość: {message}</p>\r\n'),
...
('start_promote', 'Start promote', 'Rozpoczęcie promowania ogłoszenia {classified_name} ', '<p>Witaj!&nbsp;</p>\r\n\r\n<p>Twoje ogłoszenie&nbsp;<a href=\"{classified_url}\">{classified_url}</a>&nbsp;na stronie&nbsp;<a href=\"{base_url}\">{base_url}</a>&nbsp;zaczęło&nbsp;być promowane.</p>\r\n\r\n<p>Dzięki temu będzie się wyr&oacute;żniać na tle konkurencji!</p>\r\n\r\n<p>Pozdrawiamy<br />\r\n{title}<br />\r\n<br />\r\n<a href=\"{base_url}\">{link_logo}</a></p>\r\n');
...
CREATE TABLE IF NOT EXISTS `option` (
  ...
  `categories_all` int(11) NOT NULL DEFAULT '0',
...
('days_refresh', '180'),
('days_to_remove', '90'),
('description', 'Skrypt bazy nieruchomości Holmes2 umożliwia stworzenie nowoczesnej bazy ogłoszeń online z branży nieruchomości i zarabianie na portalu.'),
('dotpay_currency', 'PLN'),
('dotpay_id', ''),
('dotpay_pin', ''),
('dotpay_test_mode', ''),
...
('footer_bottom', '<p class=\"mb-2\">Demo skryptu bazy nieruchomości HOLMES2</p>\r\n'),
('footer_text', '<p class=\"small\">Project 2019 - 2021 by <a href=\"https://itworksbetter.net\" target=\"_blank\" title=\"Creating websites\">IT Works Better</a></p>'),
('footer_top', '<p>Skrypt nieruchomości HOLMES2<br />\r\nZnajdź wymarzone mieszkanie lub dom! Nasza baza prezentuje nieruchomości z całej Polski a także z zagranicy. Znajdziesz tutaj domy jedno i wielorodzinne, mieszkania, apartamenty, działki, garaże i wiele innych obiekt&oacute;w!&nbsp;</p>\r\n\r\n<p>To jest strona pokazowa skryptu - służy jedynie pokazaniu jego funkcjonalności. Prosimy nie dodawać ofert prawdziwych obiekt&oacute;w.</p>\r\n\r\n<p>Skrypt dostępny do zakupu na <a href=\"https://skrypty.sattel.pl/skrypty-stron-www/139-skrypt-bazy-nieruchomosci-holmes2.html\">skrypty.sattel.pl/skrypty-stron-www/139-skrypt-bazy-nieruchomosci-holmes2.html</a></p>\r\n'),
('generate_sitemap', '1'),
('google_id', ''),
('google_login', '0'),
('google_maps', ''),
...
('hide_phone', '1'),
('hide_views', '0'),
('index_box_subcategories', '0'),
('index_page', '<h3 style=\"text-align:center\">WITAJ W SKRYPCIE BAZY NIERUCHOMOŚCI HOLMES2</h3>\r\n\r\n<p style=\"text-align:center\">Prezentujemy Ci jeden z najlepszych skrypt&oacute;w dla strony internetowej z bazą nieruchomości! Duża ilość opcji konfiguracyjnych umożliwia dostosowanie skryptu do potrzeb każdego portalu z bazą nieruchomości!&nbsp;</p>\r\n\r\n<p style=\"text-align:center\">To jest strona pokazowa, DEMO skryptu. Możesz zobaczyć jak wygląda Panel Administracyjny:</p>\r\n\r\n<p style=\"text-align:center\"><a href=\"https://holmes2.itworksbetter.net/admin\" target=\"_blank\" title=\"Panel Administracyjny skryptu Holmes2\">holmes2.itworksbetter.net/admin</a></p>\r\n\r\n<p style=\"text-align:center\">login: test</p>\r\n\r\n<p style=\"text-align:center\">hasło: 1234</p>\r\n\r\n<p style=\"text-align:center\">Ta strona internetowa służy pokazaniu funkcjonalności skryptu Holmes2. Prosimy nie dodawać prawdziwych ogłoszeń. Zainteresowanych zakupem zapraszam na&nbsp;<a href=\"https://skrypty.sattel.pl/skrypty-stron-www/139-skrypt-bazy-nieruchomosci-holmes2.html\" target=\"_blank\" title=\"Kup skrypt Holmes2\">skrypty.sattel.pl/skrypty-stron-www/139-skrypt-bazy-nieruchomosci-holmes2.html</a></p>\r\n'),
('keywords', 'skrypt bazy nieruchomości, skrypt real estate, baza nieruchomości'),
('lang', 'pl'),
('limit_page', '10'),
('limit_page_index', '12'),
('limit_similar', '6'),
('login_page', '<h2>Skrypt bazy nieruchomości Holmes2</h2>\r\n\r\n<h4>Zakładając konto w naszym serwisie&nbsp;uzyskasz dostęp do:</h4>\r\n\r\n<ul>\r\n	<li>Zarządzania w łatwy spos&oacute;b dodanymi ogłoszeniami</li>\r\n	<li>Listy&nbsp;wszystkich swoich ogłoszeń w jednym miejscu</li>\r\n	<li>Możliwości&nbsp;dodawania&nbsp;ogłoszeń&nbsp;do schowka i zarządzanie nimi</li>\r\n	<li>Podglądu danych os&oacute;b wystawiających ogłoszenie</li>\r\n	<li>Możliwości dodania awatara do swojego konta</li>\r\n</ul>\r\n\r\n<p>&nbsp;</p>\r\n'),
...
('social_wykop', '1'),
('template', 'default'),
('title', 'Holmes2 - skrypt bazy nieruchomości'),
('url_facebook', ''),
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `register_fb` int(1) DEFAULT '0',
  `register_google` int(1) NOT NULL DEFAULT '0',
