...
<body>
	<div id="top" class="container-fluid">
		<p class="text-right small text-white mb-0">Holmes2.1</p>
	</div>
	...
	<button class="btn btn-link back_to_top_hidden d-print-none" title="{{ 'Back to top'|trans }}" id="back_to_top"><i class="fas fa-chevron-up"></i></button>
